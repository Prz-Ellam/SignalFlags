              ...
              <div class="pt-3 px-3 h-100 overflow-hidden">
                <div class="d-flex align-items-center">
                  ...
                  >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        class="nav-link rounded-0 bg-accent"
                  ...
                  <button
                    ...
                    data-bs-target="#createHomeworkModal"
                  >
                    Nueva Tarea
                    <i class="ms-1 bi bi-flag"></i>
                  </button>
                  <button
                    class="btn border-0 bg-primary ms-2"
                    data-bs-toggle="modal"
                ...
                <div class="tab-content h-100" id="pills-tabContent">
                        ...
                        <div class="d-flex mt-3 px-3">
                          <div class="d-flex align-items-start pt-3 mt-3">
                            <img
                              ...
                              width="50"
                              height="50"
                              class="img-fluid bg-primary rounded-circle"
                              alt=""
                            />
                          </div>
                  ...
                  <div
                    class="tab-pane fade box3 group-srcoll"
                    id="pills-homework"
                    role="tabpanel"
                    aria-labelledby="pills-homework-tab"
                    tabindex="0"
                  >
                    <div class="col h-100 align-items-center p-3 text-center">
                      <div class="bg-accent rounded-3">
                        <ul
                          class="nav nav-pills mb-3 pt-1 px-2 bg-accent rounded-1"
                          id="pills-tab"
                          role="tablist"
                        >
                          <li class="nav-item" role="presentation">
                            <button
                              class="nav-link active rounded-0 bg-accent"
                              id="pills-asign_homework-tab"
                              data-bs-toggle="pill"
                              data-bs-target="#pills-asign_homework"
                              type="button"
                              role="tab"
                              aria-controls="pills-asign_homework"
                              aria-selected="true"
                            >
                              Asignadas
                            </button>
